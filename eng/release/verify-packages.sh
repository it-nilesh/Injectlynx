...
package_contains "$primary" "lib/net8.0/Injectlynx.dll"
package_contains "$primary" "lib/net9.0/Injectlynx.dll"
package_contains "$primary" "lib/net10.0/Injectlynx.dll"
